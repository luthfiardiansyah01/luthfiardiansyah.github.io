...
const getCards = () => {
        return candidates.map(candidate => {
            ...
            <img class="card-image" src="images/${candidate.id}.png">
            <div class="card-info">
...
const setWinnerLoser = (candidate) => {
    if (candidate === "chelsea") {
        document.querySelector('.btn-chelsea').textContent = "WINNER";
        document.querySelector('.btn-madrid').textContent = "LOSER";
    } else {
        document.querySelector('.btn-madrid').textContent = "WINNER";
        document.querySelector('.btn-chelsea').textContent = "LOSER";
    }
}